...
public class MaternityUtilsTest {
    ...
    @Mock
    private PncConfiguration maternityConfiguration;
    ...
    public void metadata() {
        ...
        Mockito.doReturn(maternityConfiguration).when(maternityLibrary).getPncConfiguration();
        Mockito.doReturn(maternityMetadata).when(maternityConfiguration).getMaternityMetadata();

        assertEquals(maternityMetadata, PncUtils.metadata());
    ...
    public void buildActivityFormIntentShouldCreateIntentWithWizardEnabledWhenFormHasMoreThanOneStep() throws JSONException {
        ...
        Mockito.doReturn(maternityConfiguration).when(maternityLibrary).getPncConfiguration();
        Mockito.doReturn(maternityMetadata).when(maternityConfiguration).getMaternityMetadata();
        Mockito.doReturn(BasePncFormActivity.class).when(maternityMetadata).getPncFormActivity();
